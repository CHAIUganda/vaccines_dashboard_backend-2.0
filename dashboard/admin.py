...
from cold_chain.models import FacilityType, Refrigerator, ColdChainFacility, RefrigeratorDetail
...
admin_site.register(FacilityType)
admin_site.register(Refrigerator)
