...
from dashboard.models import DataSyncTracker, DataSet, DataSyncTrackerStatus
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        data_set = DataSet()
        downloader = DataSetDownloader(data_set, 201412, self.ROOT_ORG_UNIT, DataSyncTrackerStatus.UNKNOWN)
        downloader.download()
