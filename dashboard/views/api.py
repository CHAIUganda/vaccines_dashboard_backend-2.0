...
class Months(APIView):
    def get(self, request):
        months = [{'name': 'Jan 2014', 'month': 1, 'year': 2014},
                  ...
                  {'name': 'Jul 2016', 'month': 7, 'year': 2014},
                  {'name': 'Aug 2016', 'month': 8, 'year': 2014},
                  {'name': 'Sep 2016', 'month': 9, 'year': 2014},
                  {'name': 'Oct 2016', 'month': 10, 'year': 2014},
                  {'name': 'Nov 2016', 'month': 11, 'year': 2014},
                  {'name': 'Dec 2016', 'month': 12, 'year': 2014},
