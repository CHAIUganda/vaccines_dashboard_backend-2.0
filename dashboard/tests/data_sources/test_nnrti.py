...
from dashboard.models import Balance, Consumption
...
class NNRTIDataSourceTestCaseForCurrentAdults(TestCase):
    ...
    def test_that_table_for_df1_has_2_rows(self):
        ...
        combination = DEFAULT
        score = Balance.objects.create(name=facility_name, warehouse=warehouse_name, ip=ip_name, district=district_name, REPORTING={DEFAULT: YES},
