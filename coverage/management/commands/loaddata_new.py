...
def save_from_model(period):
    sql = """select 
        ...
        where dashboard_vaccine.index > 0 and period = '%s'
        group by d.name,
        dashboard_vaccine.name,
...
def save_vaccine_dose(period):
    ...
    for d in districts:
        ...
        opv_dose1 = summary.filter(vaccine__name='OPV', dose='105-CL04. Polio 1')
        opv_dose2 = summary.filter(vaccine__name='OPV', dose='105-CL05. Polio 2')
        opv_dose3 = summary.filter(vaccine__name='OPV', dose='105-CL06. Polio 3')
        ...
        pcv_dose1 = summary.filter(vaccine__name='PCV', dose='105-CL11. PCV 1')
        pcv_dose2 = summary.filter(vaccine__name='PCV', dose='105-CL12. PCV 2')
        pcv_dose3 = summary.filter(vaccine__name='PCV', dose='105-CL13. PCV 3')
        ...
        penta_dose1 = summary.filter(vaccine__name='PENTA', dose='105-CL08. DPT-HepB+Hib 1')
        penta_dose2 = summary.filter(vaccine__name='PENTA', dose='105-CL09. DPT-HepB+Hib 2')
        penta_dose3 = summary.filter(vaccine__name='PENTA', dose='105-CL10. DPT-HepB+Hib 3')
        ...
        tt_dose1 = summary.filter(vaccine__name='TT', dose='105-TD01. Td1-Dose 1')
        tt_dose2 = summary.filter(vaccine__name='TT', dose='105-TD02. Td2-Dose 2')
        ...
        hpv_dose1 = summary.filter(vaccine__name='HPV', dose='105-VP01. HPV1-Dose 1')
        hpv_dose2 = summary.filter(vaccine__name='HPV', dose='105-VP02. HPV2-Dose 2')
        ...
        ipv_dose1 = summary.filter(vaccine__name='IPV', dose='105-CL07. IPV')
        ipv_dose2 = summary.filter(vaccine__name='IPV', dose='105-CL07. IPV')
