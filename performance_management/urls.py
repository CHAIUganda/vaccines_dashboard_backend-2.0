...
urlpatterns = [
    ...
    url(r'^api/activity', performance_management.views.api.ActivityMetrics.as_view(), name='activitymetrics'),
    url(r'^api/budgetperquarter', performance_management.views.api.BudgetPerQuarterStats.as_view(), name='budgetperquarter'),
    url(r'^api/activitystatus/(?P<pk>\d+)', performance_management.views.api.ActivityStatusRetrieveUpdate.as_view(), name='activitystatus'),
]